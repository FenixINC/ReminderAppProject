...
interface UserService {
    ...
    @POST("/login/login")
    fun userLogin(@Body login: Login): Call<ResponseBody>

    @POST("/login/create")
    fun userCreate(@Body login: Login): Call<ResponseBody>

    @POST("/login/reset")
    fun userResetPassword(@Body login: Login): Call<ResponseBody>
